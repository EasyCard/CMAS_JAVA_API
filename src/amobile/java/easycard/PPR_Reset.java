...
public class PPR_Reset extends ReqResp {
	...
	*/
	...
	public byte[] GetReq_NewLocationID() {
		return Arrays.copyOfRange(mRequest, scReqData_NewLocationID, 
	...
	public byte[] GetReq_NewServiceProviderID() {
		return Arrays.copyOfRange(mRequest, scReqData_NewServiceProviderID, 
